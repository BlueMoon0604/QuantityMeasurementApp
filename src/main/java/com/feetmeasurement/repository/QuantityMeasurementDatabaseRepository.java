...
import com.feetmeasurement.util.ConnectionUtil;
...
public class QuantityMeasurementDatabaseRepository implements IQuantityMeasurementRepository {
    ...
    public void save(QuantityMeasurementEntity entity) {
        String sql = "INSERT INTO quantity_measurements " +
                "(operand1, operand2, unit1, unit2, operation, result, measurement_type, result_unit, created_at, error, error_message) " +
                "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection connection = ConnectionUtil.getConnection();
            ...
            statement.setBoolean(10, entity.hasError());
    ...
    private QuantityMeasurementEntity mapRowToEntity(ResultSet rs) throws Exception {
        ...
        entity.setError(rs.getBoolean("error"));
